...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 24 11:25:13 2023

@author: prpa
"""
"""
Voy a realizar una solución del problema en el que se soluciona la inanición, para ello lo que tendremos 
en cuenta es el número de peatones que estan en espera. Cuando hayan esperando x cantidad de peatones, los coches
...
class Monitor():
    ...
    def __repr__(self) -> str:
        return f'Coches: {self.ncar.value}, Peatones: {self.npedestrian.value}, Peatones_esperando:{self.npedestrian_waiting.value}'
